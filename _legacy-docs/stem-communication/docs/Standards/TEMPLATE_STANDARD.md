...
Questo standard definisce la struttura che ogni documento **template** deve seguire, garantendo:
...
Si applica a: tutti i file `*_TEMPLATE.md` nella soluzione.
...
| `README_TEMPLATE.md` | Template per README di layer e progetti | Active |
...
- `Docs/Standards/` - Cartella standard di destinazione
- `Protocol/` - Posizione attuale template (da migrare)
...
| Data | Versione | Descrizione |
|------|----------|-------------|
| 2026-02-13 | 1.0 | Versione iniziale - meta-standard per template |
