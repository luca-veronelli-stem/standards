...
Questo template definisce la struttura standard per tutti i file `ISSUES.md` del progetto **Stem.Production.Tracker**, garantendo:
...
Si applica a: tutti i file `ISSUES.md` nella soluzione (`Core/`, `Services/`, `Infrastructure.*/`, `Windows.GUI/`, `Devices.*/`).
...
| Infrastructure.Persistence | `PERS-` | `PERS-001` |
| Infrastructure.Protocol | `PROT-` | `PROT-001` |
| Windows.GUI | `GUI-` | `GUI-001` |
| Devices.EdenBs8 | `EDEN-` | `EDEN-001` |
| Tests | `TEST-` | `TEST-001` |
